...
public static class BlockRegistry
{
    ...
    public static void Initialize()
    {
        Register(new BlockDefinition(
            BlockId.Air, default, BlockTransparency.Transparent));

        int stone = RegisterTexture("Assets/Textures/Blocks/stone.png");
        Register(new BlockDefinition(
            BlockId.Stone, new(stone, stone, stone)));

        int dirt = RegisterTexture("Assets/Textures/Blocks/dirt.png");
        Register(new BlockDefinition(
            BlockId.Dirt, new(dirt, dirt, dirt)));
        ...
        Register(new BlockDefinition(
            BlockId.Grass, new(grassTop, dirt, grassSide)));
        ...
        Register(new BlockDefinition(
            BlockId.OakLog, new(oakLogTop, oakLogTop, oakLogSide)));

        int oakLeaves = RegisterTexture("Assets/Textures/Blocks/oak_leaves.png");
        Register(new BlockDefinition(
            BlockId.OakLeaves, new(oakLeaves, oakLeaves, oakLeaves), BlockTransparency.Transparent));
    }
